...
\begin{tikzpicture}[xscale=1.1]
    ...
    \draw (0, -0.25) -- (0, 0.75);
    \draw (10, -0.25) -- (10, 0.75);
    \node[below right] at (  0, 0.85) {\VAR{start}};
    \node[below right] at ( 10, 0.85) {\VAR{end}};

    \draw[thick] (3.33, -0.25) -- (3.33, 0.75);
    \draw[thick] (6.66, -0.25) -- (6.66, 0.75);
    \node[below right] at (3.33, 0.85) {${\color{cbBluishGreen} \VAR{k}} \GETS (\VAR{end} - \VAR{start}) \bdiv 3$};

    \draw[thick,->] (0.5, -0.25) -- (0.5, -0.75);
    \node[right] at (0.5, -0.5) {$\AName{WeirdSort}({\color{cbSkyBlue} L[\VAR{start}\dots{\color{cbBluishGreen}\VAR{end-k}})})$};
    \draw[thick,->] (5.5, -0.25) -- (5.5, -0.75);
    \node[right] at (5.5, -0.5) {$\AName{WeirdSort}({\color{cbVermillion} L[{\color{cbBluishGreen}\VAR{start+k}}\dots\VAR{end})})$};

    \node[left,shape=rectangle,thick,draw,draw=cbOrange] at (13.5, -0.5) {$\VAR{start} < {\color{cbBluishGreen} \VAR{mid}} < \VAR{end}$};

    \node at (0.5, -1) {IH};
    \node at (5.5, -1) {IH};

    \draw[thick,->] (0.5, -1.25) -- (0.5, -1.5);
    \draw[thick,->] (5.5, -1.25) -- (5.5, -1.5);

    \draw[cbSkyBlue,fill=cbSkyBlue!10] (0, -2) rectangle (6.66, -1.5);
    \node at (2.25, -1.75) {$L_1$: ${\color{cbSkyBlue} L[\VAR{start}\dots{\color{cbBluishGreen}\VAR{end-k}})}$, but sorted};
    ...
    \draw[cbVermillion,fill=cbVermillion!10] (5.25, -3.5) rectangle (10.25, -3);
    \node at (7.75, -3.25) {$L_2$: ${\color{cbVermillion} L[{\color{cbBluishGreen}\VAR{mid}}\dots\VAR{end})}$, but sorted};

    % \draw[thick] (4.75, -1.75) -- (5.25, -1.75);
    % \draw[thick,->] (5, -1.75) -- (5, -3);
    % \node[right] at (5, -2.5) {\textcolor{cbReddischPurple}{Merge}};

    \draw (0, -5) rectangle (10, -5.5);
    \node[left,shape=rectangle,thick,draw,draw=cbOrange] at (13.75, -2.5) {Assumption: \textcolor{cbReddischPurple}{Merge} is correct};
    \node at (5, -5.25) {Values in $L_1$ (${\color{cbSkyBlue} L[\VAR{start}\dots{\color{cbBluishGreen}\VAR{end-k}})}$) and $L_2$ (${\color{cbVermillion} L[{\color{cbBluishGreen}\VAR{mid}}\dots\VAR{end})}$), sorted};
\end{tikzpicture}
