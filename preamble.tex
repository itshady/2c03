...
\newcommand{\Weight}{\mathord{\textit{weight}}}
\newcommand{\ID}[1]{\operatorname{id}(#1)}
\newcommand{\OutE}[1]{\operatorname{out}(#1)}
...
\newcommand{\Assignment}[1]{
    \title{\vskip-2em%The standard article.cls package puts 2em whitespace on top of the title, undo this.
           Assignment #1 - \Large{Hady Ibrahim (400377576)}\\{\Large SFWRENG 2CO3: Data Structures and Algorithms--Winter 2023}}}
